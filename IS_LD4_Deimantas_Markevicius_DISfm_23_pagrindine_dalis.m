...
% Radial basis networks (spindulio tipo bazinių funkcijų tinklas) --> gauso
% funkcija
% P - Tai yra įėjimo duomenys (arba požymiai) tinklui. Šie duomenys yra naudojami tinklo mokymui, kad jis galėtų atpažinti tam tikrus modelius ar raides.
% T - Tai yra norimi išėjimai arba tikslai, kuriuos tinklas turėtų generuoti atitinkantys įėjimo duomenis. Pvz., jei P yra raidžių požymiai, tai T bus atitinkamos raidės, kurias šie požymiai atspindi.
% 0 - Šis parametras nurodo klaidos ribą (goal error). Tai yra maksimali leistina klaida tinklo atsakyme. Jeigu tinklo generuojama klaida yra mažesnė ar lygi šiam skaičiui, tinklas baigia mokymąsi.
% 1 - Tai yra tinklo apytikslio atsakymo plitimo koeficientas (spread). Dideli spread reikšmės reiškia, kad tinklo atsakymas bus apytikslis ir galės apimti didesnį duomenų diapazoną, o mažos reikšmės reiškia, kad tinklas bus labiau specifinis ir tikslesnis savo atsakyme.
% 13- Tai yra maksimalus neuronų skaičius tinklo paslėptajame sluoksnyje. Šis parametras apibrėžia, kiek maksimaliai neuronų gali būti sukurti mokymo proceso metu. 
